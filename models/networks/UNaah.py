...
class UNaah(nn.Module):
    ...
    def __init__(self,
                 ...
                 shortcut_features='default',
                 classes=21,
                 decoder_filter_block=64,
                 parametric_upsampling=True,
                 decoder_use_batchnorm=True):
        super(UNaah,self).__init__()
        decoder_filters = (decoder_filter_block*16,decoder_filter_block*8,decoder_filter_block*4,
        decoder_filter_block*2,decoder_filter_block)
        ...
        self.decoder1 = Decoder(backbone_name=backbone_name,
                 ...
                 parametric_upsampling=parametric_upsampling,
                 shortcut_features=shortcut_features,
...
if __name__ == "__main__":
    ...
    # simple test run
    net = UNaah(backbone_name='resnet50')
